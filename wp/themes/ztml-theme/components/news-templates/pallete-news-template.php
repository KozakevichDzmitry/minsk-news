...
?>
	<?php render_topic_bar("Палитра дня", true, array(
		'link' => get_site_url() . '/news-list/palitra/',
	...
	<?php $pallete_news_attached_posts = get_attached_news('2', 'palitra', null, true); ?>
	<?php $pallete_news_posts = get_default_news('2', 'palitra', $pallete_news_attached_posts['ids']); ?>

	<div class="box-column-gap pallete-news palitra" style="margin-bottom: 30px;">
		<div class="box-line-gap">
			<div class="box" data-postid="<?php echo $pallete_news_attached_posts['posts'][0]->ID;?>">
