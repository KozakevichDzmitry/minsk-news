...
function render_most_read_news_template($is_minimazed = false, $type_adv = "page", $id = false)
{
	...
	render_topic_bar("Самое читаемое", true, array(
		'link' => get_site_url() . '/news-list/most-read/',
	...
	<?php if ($is_minimazed) : ?>
		<?php $most_read_attached_posts = get_attached_news('4', 'most-read'); ?>

		<div class="box-column-gap most-read" style="margin-bottom: 30px;">
			<div class="box-line-gap">
				<div class="box">
					<?php render_new_template_image($most_read_attached_posts['posts'][0]->ID); ?>
				</div>
				<div class="box box-list">
					<?php render_news_template_line($most_read_attached_posts['posts'][2]->ID, false, true); ?>
					<?php render_news_template_line($most_read_attached_posts['posts'][3]->ID, false, true); ?>
				</div>
			</div>
			<div class="box">
	...
	<?php else : ?>
		<?php $most_read_attached_posts = get_attached_news('4', 'most-read', null , true); ?>
		<?php $most_read_posts = get_default_news('4', 'most-read', $most_read_attached_posts['ids']); ?>
		<div class="box-column-gap most-read" style="margin-bottom: 30px;">
			<div class="box-line-gap">
				<div class="box" data-postid="<?php echo $most_read_attached_posts['posts'][0]->ID; ?>">
					<?php render_new_template_image($most_read_attached_posts['posts'][0]->ID); ?>
				</div>
				<div class="box box-list">
			...
			<div class="box-line-reverse-gap">
				<div class="box" data-postid="<?php echo $most_read_attached_posts['posts'][2]->ID;?>">
