...
function render_economy_news_template($is_minimazed = false, $is_district_page = false, $tax_slug = '', $type_adv = "page", $id = false)
{
	...
	render_topic_bar("Экономика", true, array(
		'link' => get_site_url() . '/news-list/economics/',
	...
	<div class="box-column-gap economy-news economics" style="margin-bottom: 30px;">
		<?php $economy_attached_posts = get_attached_news('3', 'economics', $tax_query); ?>
		<?php if ($is_minimazed) : ?>
			<div class="box-line-reverse-gap">
				...
				<div class="box box-list">
					<?php render_news_template_line($economy_attached_posts['posts'][1]->ID, false, true); ?>
					<?php render_news_template_line($economy_attached_posts['posts'][2]->ID, false, true); ?>
				</div>
			</div>
		<?php else : ?>
			<?php $economy_attached_posts = get_attached_news('3', 'economics', $tax_query, true); ?>
			<?php $economy_posts = get_default_news('4', 'economics', $economy_attached_posts['ids']); ?>
			<div class="box-line-reverse-gap">
				<div class="box" data-postid="<?php echo $economy_attached_posts['posts'][0]->ID;?>">
					<?php render_new_template_image($economy_attached_posts['posts'][0]->ID); ?>
				</div>
				<div class="box box-list">
			...
			<div class="box-line-gap">
				<div class="box" data-postid="<?php echo $economy_attached_posts['posts'][1]->ID;?>">
