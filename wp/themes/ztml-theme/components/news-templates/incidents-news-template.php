...
?>
	<?php render_topic_bar("Происшествия", true, array(
		'link' => get_site_url() . '/news-list/insidents/',
	...
	<?php $incidents_attached_posts = get_attached_news('3', 'insidents', null, true); ?>
	<?php $incidents_posts = get_default_news('4', 'insidents', $incidents_attached_posts['ids']); ?>

	<div class="box-column-gap incidents-news insidents" style="margin-bottom: 30px;">
		<div class="box">
			<?php render_news_template_line($incidents_attached_posts['posts'][0]->ID, true, false); ?>
		</div>
		<div class="box-line-reverse-gap">
			<div class="box" data-postid="<?php echo $incidents_attached_posts['posts'][1]->ID;?>">
		...
		<div class="box-line-gap">
			<div class="box" data-postid="<?php echo $incidents_attached_posts['posts'][2]->ID;?>">
