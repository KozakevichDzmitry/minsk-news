...
?>
	<?php render_topic_bar("Культура", true, array(
		'link' => get_site_url() . '/news-list/culture/',
	...
	<?php $culture_attached_posts = get_attached_news('2', 'culture', null, true); ?>
	<?php $culture_economy_posts = get_default_news('2', 'culture', $culture_attached_posts['ids']); ?>


	<div class="box-column-gap culture-news culture" style="margin-bottom: 30px;">
		<div class="box">
			<?php render_news_template_line($culture_attached_posts['posts'][0]->ID, true, false); ?>
		</div>
		<div class="box-line-reverse-gap">
			<div class="box" data-postid="<?php echo $culture_attached_posts['posts'][1]->ID;?>">
