...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700&family=Noto+Sans:ital,wght@0,400;0,500;0,700;0,900;1,400;1,500;1,700;1,900&family=Roboto:wght@400;500;700&display=swap" rel="stylesheet">
   <script>
		window.yaContextCb = window.yaContextCb || []
	</script>
	<script src="https://yandex.ru/ads/system/context.js" async></script>
    <!-- Yandex.Metrika counter --><script type="text/javascript" > (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)}; m[i].l=1*new Date(); for (var j = 0; j < document.scripts.length; j++) {if (document.scripts[j].src === r) { return; }} k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}) (window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "ym"); ym(91431825, "init", { clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true, trackHash:true }); </script> <noscript><div><img src="https://mc.yandex.ru/watch/91431825" style="position:absolute; left:-9999px;" alt="" /></div></noscript> <!-- /Yandex.Metrika counter -->
    <!-- Google tag (gtag.js) -->
	...
	<?php elseif (is_404()) : ?>
        ...
        <meta property="og:image" content="<?php echo site_url('/wp-content/uploads/2023/01/logo-150x130.jpeg', 'https')?>" />
	<?php endif; ?>
			...
			<div class="container">
				<nav class="main-nav">
					<div class="right-half">
						<div>
							<a href="/" id="logo">
								<img alt="logo" src="<?php echo get_template_directory_uri() . '/assets/images/logo.svg'; ?>">
							</a>
						</div>
						<div class="nav-list">
