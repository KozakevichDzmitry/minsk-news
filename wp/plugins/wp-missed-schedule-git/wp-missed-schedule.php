			...
			if ( $wp_version < 2.8 )
				{
					...
					if ( ( $scheduled_missed !== false ) && ( $scheduled_missed > ( time() - ( 300 ) ) ) )
						return;
				}
					...
					if ( $wp_version < 3.0 )
						{
							...
							get_transient( 'scheduled_missed', $scheduled_missed, 300 );

							if ( ( $scheduled_missed !== false ) && ( $scheduled_missed > ( time() - ( 300 ) ) ) )
								return;

							set_transient( 'scheduled_missed', $scheduled_missed, 300 );
						}
							...
							if ( is_multisite() )
								{
									...
									get_site_transient( 'scheduled_missed', $scheduled_missed, 300 );

									if ( ( $scheduled_missed !== false ) && ( $scheduled_missed > ( time() - ( 300 ) ) ) )
										return;

									set_site_transient( 'scheduled_missed', $scheduled_missed, 300 );
								}
						}
				}
